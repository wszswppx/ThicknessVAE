...
我的：
```bash
CUDA_VISIBLE_DEVICES=3,6 python -m torch.distributed.launch --nproc_per_node=2 --use_env mytrain.py --exp_name thuman --lr 0.001 --epochs 400 --batch_size 8 --coarse_loss cd
```
打开tensorboard  
```bash
cd /data/home/wuxiaotao/project/pcn
